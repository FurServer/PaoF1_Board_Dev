...
void lcd1602_blink_on(lcd1602_t *lcd);    // 开启光标闪烁
void lcd1602_blink_off(lcd1602_t *lcd);   // 关闭光标闪烁
...
void lcd1602_set_wrap(lcd1602_t *lcd, uint8_t enable); // 设置自动换行: 0=关闭, 非0=开启
